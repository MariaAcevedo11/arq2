...
from .views import HomePageView, AboutPageView, ProductIndexView, ProductShowView, ProductCreateView, ContactPageView, CartView, CartRemoveAllView, ImageViewNoDI
from pages.views import ImageViewFactory
